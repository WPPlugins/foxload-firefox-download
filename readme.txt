...
1. Upload folder `foxload-firefox-download` to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Go to settings -> Foxload and configure banner size and colors
1. Place `<?php if(function_exists('get_foxload_button'))get_foxload_button(); ?>` in your template or use the sidebar widgets.
